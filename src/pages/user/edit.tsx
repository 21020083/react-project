...
export default function UserForm() {
    ...
    return(
        <>
        {}<h2 className="text-center mb-3"> {id ? "Edit User" : "Create New User"} </h2>
        <div className="row">
                ...
                <form onSubmit={(event) => handleSubmit(event)}>
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-8">
                            <input className="form-control" name="name" defaultValue={user.name}/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label className="col-sm-4 col-form-label">Email</label>
                        <div className="col-sm-8">
                            <input className="form-control" name="email" defaultValue={user.email}/>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-sm-4 d-grid">
                            <Link to="/user"><button type="button" className="btn btn-secondary me-2"> Back </button></Link>
                        </div>
                    </div>
                </form>
            </div>
